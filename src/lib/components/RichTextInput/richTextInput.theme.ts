...
const richTextInputMarkdownContent =
	'[&>*:first-child]:mt-0 [&>*:last-child]:mb-0 [&_a]:font-medium [&_a]:text-primary-readable [&_a]:underline [&_blockquote]:my-md [&_blockquote]:border-l-4 [&_blockquote]:border-neutral/30 [&_blockquote]:pl-xl [&_blockquote]:italic [&_blockquote]:text-neutral/70 [&_code]:rounded-sm [&_code]:bg-surface-canvas [&_code]:px-sm [&_code]:py-micro [&_code]:font-mono [&_code]:text-xs [&_code]:text-neutral [&_del]:text-neutral/70 [&_em]:italic [&_h1]:mb-sm [&_h1]:mt-xl [&_h1]:text-xl [&_h1]:font-semibold [&_h1]:text-neutral [&_h2]:mb-sm [&_h2]:mt-xl [&_h2]:text-lg [&_h2]:font-semibold [&_h2]:text-neutral [&_h3]:mb-sm [&_h3]:mt-xl [&_h3]:text-base [&_h3]:font-semibold [&_h3]:text-neutral [&_li]:py-0 [&_mark]:rounded-sm [&_mark]:bg-warning-muted [&_mark]:text-warning-muted-readable [&_ol]:my-md [&_ol]:ml-lg [&_ol]:list-inside [&_ol]:list-decimal [&_ol]:whitespace-normal [&_p]:my-md [&_p]:text-neutral [&_strong]:font-semibold [&_ul]:my-md [&_ul]:ml-lg [&_ul]:list-inside [&_ul]:list-disc [&_ul]:whitespace-normal';
