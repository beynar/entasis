...
export const circleIconFill = icon('M232,128A104,104,0,1,1,128,24,104.13,104.13,0,0,1,232,128Z');

export const circleIconLight = icon(
...
export const circleIconThin = icon(
	'M128,28A100,100,0,1,0,228,128,100.11,100.11,0,0,0,128,28Zm0,192a92,92,0,1,1,92-92A92.1,92.1,0,0,1,128,220Z'
);
