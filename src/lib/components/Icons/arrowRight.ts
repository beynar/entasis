...
export const arrowRightIconBold = icon(
...
export const arrowRightIconDuotone = icon(
	'M216,128l-72,72V56Z',
	'M221.66,122.34l-72-72A8,8,0,0,0,136,56v64H40a8,8,0,0,0,0,16h96v64a8,8,0,0,0,13.66,5.66l72-72A8,8,0,0,0,221.66,122.34ZM152,180.69V75.31L204.69,128Z'
);

export const arrowRightIconFill = icon(
	'M221.66,133.66l-72,72A8,8,0,0,1,136,200V136H40a8,8,0,0,1,0-16h96V56a8,8,0,0,1,13.66-5.66l72,72A8,8,0,0,1,221.66,133.66Z'
);

export const arrowRightIconLight = icon(
...
export const arrowRightIconThin = icon(
