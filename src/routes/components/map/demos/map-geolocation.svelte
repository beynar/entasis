	...
	>
		{#snippet controlButton(button: MapControlButtonSnippetArg)}
			...
			<Button
				...
				size="small"
				class="bg-surface/95 rounded-none"
		...
		{#snippet userLocationMarker(location: MapUserLocationSnippetArg)}
			<span
				class="bg-primary text-primary-contrast ring-primary/25 grid size-8 place-items-center rounded-full text-[10px] font-semibold shadow-md ring-4"
			>
