  ...
  >
    {#snippet marker(arg: MapMarkerSnippetArg<OfficeData>)}
      <button
        type="button"
        class={[
          "flex min-w-28 flex-col items-center rounded-lg px-3 py-2 text-xs shadow-lg ring-4 outline-none transition-transform hover:-translate-y-0.5 focus-visible:ring-primary",
