<script lang="ts">
	...
	import { Select, type SelectItems } from 'entasis/select';
	import { Tabs } from 'entasis/tabs';
	import { TextInput } from 'entasis/text-input';
	import type { SidebarGroup, SidebarIcon } from 'entasis/sidebar';
	import { calendarBlankIcon } from 'entasis/icons/calendarBlank';
	import { chartBarIcon } from 'entasis/icons/chartBar';
	import { cubeIconFill } from 'entasis/icons/cube';
	import { dotsSixVerticalIcon } from 'entasis/icons/dotsSixVertical';
	import { leafIconFill } from 'entasis/icons/leaf';
	import { planetIconFill } from 'entasis/icons/planet';
	import { sparkleIconFill } from 'entasis/icons/sparkle';
	import { fileTextIcon } from 'entasis/icons/fileText';
	import { flowerIconFill } from 'entasis/icons/flower';
	import { gearIcon } from 'entasis/icons/gear';
	import { houseIcon } from 'entasis/icons/house';
	import { kanbanIcon } from 'entasis/icons/kanban';
	...
	import { rocketLaunchIcon } from 'entasis/icons/rocketLaunch';
	import { shieldCheckIcon } from 'entasis/icons/shieldCheck';
	import { sidebarSimpleIcon } from 'entasis/icons/sidebarSimple';
	import { sortAscendingIcon } from 'entasis/icons/sortAscending';
